/* ===========================================================================
   ...
   Widgets/canvas helpers come from window.DemoKit (assets/js/demo-kit.js).
   Registers into window.ArticleDemos = { prediction, reconciliation,
   interpolation, lagcomp }. article.js swaps a "[demo:<id>]" paragraph for
   the mounted widget.
   =========================================================================== */
(function () {
  'use strict';
  ...
  var trackX = K.trackX, drawDot = K.drawDot, laneLine = K.laneLine, tag = K.tag, loop = K.loop;
  ...
  window.ArticleDemos.prediction = prediction;
  window.ArticleDemos.reconciliation = reconciliation;
  window.ArticleDemos.interpolation = interpolation;
  window.ArticleDemos.lagcomp = lagcomp;
})();
