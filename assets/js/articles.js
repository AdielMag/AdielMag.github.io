...
window.ARTICLES = [
  ...
  },
  {
    ...
    hero: 'assets/img/splash-claude-memory-vault.jpg',
    date: 'Jul 13, 2026',
    dateISO: '2026-07-13',
    status: 'published',
  },
  ...
  },
  {
    ...
    hero: 'assets/img/splash-manipulation-resistance-index.jpg',
    date: 'Jul 13, 2026',
    dateISO: '2026-07-13',
    status: 'published',
  },
  {
    ...
    hero: 'assets/img/splash-backtest-confessions.jpg',
    date: 'Jul 13, 2026',
    dateISO: '2026-07-13',
    status: 'published',
  },
  {
    slug: 'better-find-in-files',
    tag: 'Engine',
    tagColor: '#c9c2d6',
    tagBg: 'rgba(201,194,214,0.14)',
    accent: 'muted',
    title: "I missed Rider's Find in Files, so I rebuilt it for VS Code",
    excerpt: 'A VS Code extension with a floating Rider-style search modal: four modes in one shortcut, results streamed from the ripgrep VS Code already ships, and semantic usages from your language server.',
    hero: 'assets/img/splash-better-find-in-files.jpg',
    date: 'Aug 10, 2026',
    dateISO: '2026-08-10',
    status: 'published',
  },
